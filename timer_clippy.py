...
class Clippy():
    ...
    def close(self, root):
        self.close_status = True  # Set the return value
        root.destroy()
    ...
    def run(self):        
        ...
        wrapped_text = self.wrap_text(random.choice(self.dialog.splitlines()), font, max_text_width, draw)
        ...
        close_button = tk.Button(root, text="  X  ", command=lambda: self.close(root), bg="red", fg="white", bd=0)  # Extra spaces for width
        ...
        root.after(self.ttl, root.destroy)
